    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="home" className={`pb-16 pt-12 md:pb-24 ${CONTAINER}`}>
        <div className="grid items-center gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            {/* Doctor photo with overlapping clinical visual items in different sizes */}
            <div className="relative">
              ...
              {/* Floating Card 1: Stethoscope beat (small size) */}
              <div className="absolute -left-10 bottom-16 hidden sm:flex w-[190px] flex-col rounded-2xl border border-white/10 bg-navy/80 p-3 shadow-glow backdrop-blur-md animate-float">
                <div className="overflow-hidden rounded-xl h-24 relative">
                  <Image
                ...
                <p className="mt-2 text-[10px] text-white/90 font-medium">Real-time Vitals Sync</p>
                <div className="mt-1 flex items-center justify-between">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
                  <span className="text-[8px] text-emerald-400 font-mono">Telemetry Active</span>
                </div>
              </div>

              {/* Floating Card 2: EMR Tablet (medium size) */}
              <div className="absolute -right-8 top-16 hidden sm:flex w-[210px] flex-col rounded-2xl border border-white/10 bg-navy/80 p-3 shadow-glow backdrop-blur-md animate-float" style={{ animationDelay: "2s" }}>
                <div className="overflow-hidden rounded-xl h-28 relative">
                  <Image
                    src="/emr-tablet.jpg"
                ...
                <p className="mt-2 text-[10px] text-white/90 font-medium">EHR Medical Integration</p>
                <div className="mt-1 flex items-center gap-1.5">
                  <span className="text-[8px] bg-white/10 text-white/70 px-1.5 py-0.5 rounded font-mono">TEFCA</span>
                  <span className="text-[8px] bg-white/10 text-white/70 px-1.5 py-0.5 rounded font-mono">QHIN</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className={`py-24 ${CONTAINER}`}>
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <span className="text-sm font-semibold uppercase tracking-wider text-primary">State-of-the-Art Diagnostics</span>
            <h2 className="mt-3 text-4xl md:text-5xl leading-tight text-foreground font-display">
              Clinical telemetry meets patient care.
            </h2>
            <p className="mt-6 text-muted-foreground text-base leading-relaxed">
              TrialCliniq integrates directly with hospital ICU monitors, patient telemetry systems, and digital health records to stream vital signs securely. By analyzing real-time data, our platform flags critical cardiac and neurological trends before symptoms worsen.
            </p>
            <div className="mt-8 space-y-4">
              {[
                "Automatic ICU telemetry and EMR system synchronization",
                "Advanced cardiac and brain telemetry analysis patterns",
                "Early warning triggers for specialist referral coordination",
              ].map((text, i) => (
                <div key={i} className="flex items-start gap-3">
                  <div className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-emerald-500/10 text-emerald-600">
                    <Check className="h-3 w-3" />
                  </div>
                  <span className="text-sm text-foreground/80 font-sans">{text}</span>
                </div>
              ))}
            </div>
          </div>

          {/* Mosaic Grid of Images in different sizes */}
          <div className="grid grid-cols-2 gap-4">
            <div className="overflow-hidden rounded-3xl border border-border shadow-card h-[320px] relative col-span-2 group">
              <Image
                src="/icu-monitor.jpg"
                alt="ICU Vitals Telemetry"
                fill
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent flex items-end p-6">
                <div>
                  <span className="text-[10px] uppercase tracking-wider text-emerald-400 font-semibold font-mono">Continuous Telemetry</span>
                  <h4 className="text-lg text-white font-medium mt-1 font-display">Real-time ICU vital feeds and EKG sync</h4>
                </div>
              </div>
            </div>

            <div className="overflow-hidden rounded-3xl border border-border shadow-card h-[220px] relative group">
              <Image
                src="/heart-pulse.jpg"
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-transparent to-transparent flex items-end p-4">
                <span className="text-xs text-white font-medium">Cardiac Screening</span>
              </div>
            </div>

            <div className="overflow-hidden rounded-3xl border border-border shadow-card h-[220px] relative group bg-[#0d2847] flex flex-col justify-between p-6 text-white transition-all duration-300 hover:shadow-glow">
              <Image
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-transparent to-transparent flex items-end p-4">
                <span className="text-xs text-white font-medium">Automated screening triggers specialist referrals instantly</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="overflow-hidden rounded-[2.5rem] border border-border bg-navy p-8 text-navy-foreground md:p-14">
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            <div>
              ...
              <NextLink
                href="/portal"
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-medium text-primary-foreground transition hover:opacity-90 shadow-lg shadow-primary/20"
              >
      ...
      <section className={`pb-16 ${CONTAINER}`}>
        <div className="overflow-hidden rounded-[2.5rem] bg-primary px-8 py-14 text-primary-foreground md:px-16">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <NextLink
              href="/portal"
              className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-medium text-primary hover:bg-white/90 transition shadow-lg"
            >
              Get Started <ArrowRight className="h-4 w-4" />
            </NextLink>
            <NextLink
              href="/contact"
              className="inline-flex items-center gap-2 rounded-full border border-white/30 px-6 py-3 text-sm font-medium text-primary-foreground hover:bg-white/10 transition"
            >
      ...
      <footer id="contact" className="border-t border-border">
        <div className={`grid gap-10 py-16 md:grid-cols-4 ${CONTAINER}`}>
          ...
          <FooterColumn
            title="Services"
            links={[
              { label: "Appointments", href: "/portal" },
              { label: "Prescriptions", href: "/portal" },
              { label: "Lab Results", href: "/portal" },
              { label: "Secure Messaging", href: "/portal" },
            ]}
          />
          <div>
  ...
  return (
    <div>
      ...
      <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
        {links.map((l) => (
          <li key={l.label}>
            <NextLink href={l.href} className="hover:text-foreground">
              {l.label}
            </NextLink>
          </li>
        ))}
